    ...
    <main>
        ...
        <div className="info">
            <div className="infobox">
                ...
                <div className="conteudo">No momento você possui <strong>02</strong> pontos para troca.</div>

                <div className="titulo">PEDIDOS DE TROCA QUE ATENDI:</div>
                <div className="conteudoPedidos">#1111 - Didi Mocó | Em: 07/07/2020
                ...
                <div className="total">TOTAL DE TROCAS QUE ATENDI: <strong>06</strong></div>
            </div> 
            <div className="infobox2">
                    <div className="botoes"> <button type="button" className="botaoVerde">PRECISO OBTER PONTOS</button> 
                        <button type="button" className="botaoRosa">QUERO COMPRAR PONTOS</button></div>
                    ...
                    <div className="total">TOTAL DE TROCAS QUE SOLICITEI: <strong>06</strong></div>
            </div>
        </div>
    </main>
  );
