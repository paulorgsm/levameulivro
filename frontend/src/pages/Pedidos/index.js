        ...
        <div className="full-table">
          <table>
            ...
            <tr className="table">
              ...
              <td>
                <i className="fas fa-user-circle fa-2x"></i> Didi Mocó da Silva
                José Gardenal
          ...
          <div id="details-orders" className="details">
            <div className="order-details">
              ...
              <p>
                <b>Status do Pedido:</b> <a href="#">Aguardando Sua Análise</a>
              </p>
              <p>
                <b>Mensagens:</b>{" "}
        ...
        <div className="full-table">
          ...
          <div id="details-wishes" className="details">
            <div className="order-details">
              ...
              <p>
                <b>Título do Livro:</b> Pensamento Crítico: O poder da Lógica e
                da argumentação
              </p>
              <p>
                <b>Data do Pedido:</b> 16/05/2021 às 10:23:34
            ...
            <div className="order-historic">
              <div className="order-historic-one">
                <h4>Histórico do Pedido / Orientações:</h4>
                <p>
                  <b>Data:</b> 16/05/2021 às 11:54:13 | Status: Pedido de Troca
                  Confirmado
                </p>
                <p>
