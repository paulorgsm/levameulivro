        ...
        <div className="mostrarInfoLivro">
          ...
          <div className="informacoesLivro">
            <h1 className="centralizar negrito">
              NOME DO LIVRO COM ATÉ 2 LINHAS DE CARACTERES NOME DO LIVRO COM ATÉ
              2 LINHAS DE CARACTERES NOME DO{" "}
            </h1>
      ...
      <section class="sessao">
        ...
        <div>
          <p class="txt">
            ...
            de mula manquis sem cabeça. Diuretics paradis num copo é motivis de
            denguis. Nullam volutpat risus nec leo commodo, ut interdum diam
            laoreet. Sed non consequat odio. A ordem dos tratores não altera o
            pão duris.
          </p>
          <p class="txt">
            {" "}
          ...
          <p class="txt">
            ...
            euzis! Mais vale um bebadis conhecidiss, que um alcoolatra anonimis.
          </p>
          <p class="txt">
            {" "}
            faiz malandris se pirulitá. Detraxit consequat et quo num tendi
            nada. Interessantiss quisso pudia ce receita de bolis, mais bolis eu
            num gostis. Viva Forevis aptent taciti sociosqu ad litora torquent.
          </p>
          <p class="txt">
            Manduma pindureta quium dia nois paga. Mé faiz elementum girarzis,
            nisi eros vermeio. Não sou faixa preta cumpadi, sou preto inteiris,
            inteiris. Suco de cevadiss deixa as pessoas mais interessantis.
          </p>
          <p class="txt">
            ...
            e fermentis. Vehicula non. Ut sed ex eros. Vivamus sit amet nibh non
            tellus tristique interdum. Aenean aliquam molestie leo, vitae
            iaculis nisl.
          </p>
        </div>
        <div class="border"></div>
